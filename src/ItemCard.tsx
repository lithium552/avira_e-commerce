...
const ItemCard = ({data} : propsItemCard) => {
    console.log(data)
  return (
    <div className='flex justify-between gap-28 flex-wrap'>
            {data.map(item => (
              <div className='relative'>
                ...
                {item.isFavorite ? (
                  <svg className='absolute bottom-44 right-4' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  (<svg className='absolute bottom-44 right-4' width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className='line-through mr-2 text-textColorTertiary font-semibold text-sm inline-block mb-4'>Rs. {item.oldPrice}</span>
