...
import { updateWomenProducts } from '../features/products/womanProductsSlice'
    ...
    <div className='grid grid-cols-4 gap-x-16 gap-y-12'>
            {data.map(item => (
              <div className='relative' key={item.id}>
                ...
                <div className='w-14 h-6 flex justify-around text-xs font-semibold rounded items-center absolute bottom-44 left-4 bg-white'>
                ...
                {item.isFavorite ? (
                  <svg onClick={() => dispatch(updateWomenProducts(item))} className='absolute bottom-44 right-4 hover:cursor-pointer' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  (<svg onClick={() => dispatch(updateWomenProducts(item))} className='absolute bottom-44 right-4 hover:cursor-pointer' width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
